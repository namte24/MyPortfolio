        ...
        <section ref={ref} className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]" id="home">
            <div className="flex items-center justify-center">
                <div className="relative">
                    ...
                    alt="Profile" width={192} height={192} quality={95} priority={true}
            ...
            >
            <span className="font-bold">Hello, I&apos;m Tenzing.</span> I&apos;m a{" "}
            ...
            >
                ...
                outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 transition">Contact me here <BsArrowRight
                ...
                <a href="/resume.pdf" download className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 
                ...
                href="https://www.linkedin.com/in/tenzing-bhutia-a67b3b22a/" target="blank"
                ><BsLinkedin/></a>
                
                <a className="bg-white p-4 text-gray-700 flex items-center gap-2 rounded-full text-[1.35rem] focus:scale-[1.15]
                hover:scale-[1.15] hover:text-gray-950  active:scale-105 transition cursor-pointer border border-black/10 dark:bg-white/10 dark:text-white/60"
                href="https://github.com/namte24" target="blank"
                ><FaGithubSquare/></a>
            </motion.div>
        </section>
    );
